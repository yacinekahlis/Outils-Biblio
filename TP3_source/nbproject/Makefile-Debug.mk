...
${TESTDIR}/BibliographieTesteur.o: BibliographieTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/BibliographieTesteur.o BibliographieTesteur.cpp


${TESTDIR}/JournalTesteur.o: JournalTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/JournalTesteur.o JournalTesteur.cpp


${TESTDIR}/OuvrageTesteur.o: OuvrageTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/OuvrageTesteur.o OuvrageTesteur.cpp


${TESTDIR}/ReferenceTesteur.o: ReferenceTesteur.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/ReferenceTesteur.o ReferenceTesteur.cpp
